// app/sommelier/wine-list.js — placeholder for the "Choose from a list" tool.
//
    ...
    <View style={styles.safeArea}>
      ...
      {isPro ? (
        <View style={styles.centered}>
          <Text style={styles.title}>A few good picks from the list in front of you</Text>
          <Text style={styles.body}>This tool is being finished right now and will be in the next update.</Text>
        </View>
      ) : (
        <ProFeaturePreview source="wine_list_pick" title="A few good picks from the list in front of you" body="Photograph a wine list and the sommelier picks two or three bottles in your budget, with a reason each, grounded in what you have rated.">
