...
const COMPARE = [
  ...
  { label: 'Choose from a wine list', free: null, pro: 'Included' },
  { label: 'Your taste report', free: null, pro: 'Included' },
  { label: 'Plan a wine day', free: null, pro: 'Included' },
  { label: 'US wine regions on the map', free: null, pro: 'Included' },
