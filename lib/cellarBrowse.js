...
// soonest-to-act first (past peak / drink up), then ready, young, then unknown last.
...
const readinessRank = (status) => (status in READINESS_RANK ? READINESS_RANK[status] : 99);
