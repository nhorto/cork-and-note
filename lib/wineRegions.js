...
const REGION_ROWS = [
  ...
  ['Virginia', 'United States', 'VA', 'Commonwealth of Virginia'],
  ['Monticello', 'Virginia'],
  ...
  // Washington
  ['Washington', 'United States', 'WA', 'Washington State'],
  ...
  // New York
  ['New York', 'United States', 'NY', 'New York State'],
  ...
  ['Champagne', 'France'],
  ['Rhône Valley', 'France', 'Rhône', 'Rhone'],
