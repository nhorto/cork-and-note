...
// inline the hex values (kept in sync with colors.status / colors.accent). UI code
...
export const DRINK_WINDOW_META = {
  ...
  ready: {
    ...
    label: 'Ready',
    short: 'Ready',
    color: '#557753', // colors.status.visited (sage)
  ...
  drink_up: {
    ...
    label: 'Drink soon',
    short: 'Drink soon',
    color: '#C97A3D', // colors.accent.strong
  ...
  past_peak: {
    ...
    label: 'Past peak',
    short: 'Past peak',
    color: '#C1293E', // colors.status.error
...
export const DRINK_WINDOW_UNKNOWN = {
  ...
  label: 'No window',
  short: 'No window',
  color: '#7A5A4E', // colors.neutral.inkTertiary
