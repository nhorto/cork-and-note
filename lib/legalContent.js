...
//
// ⚠️ Still outstanding (owner-checklist D): a support email address. The
// contact route below is deliberately the in-app form, which exists and works;
// swap in the mailbox once it is confirmed, in PRIVACY_POLICY "Who we are" and
// TERMS_OF_USE "Your account", and bump `updated` on both documents.
