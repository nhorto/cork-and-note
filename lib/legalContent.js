...
// (#162, App Store requirement). Mirrored as markdown in docs/legal/ for the
// future hosted versions — keep the two in sync when editing.
//
// ⚠️ Owner review required before App Store submission (owner-checklist D):
// governing-law state and, once they exist, the support email and hosted URLs.
  ...
  sections: [
    {
      heading: 'Who we are',
      paragraphs: [
        'Cork & Note is a wine tasting journal operated by Nicholas Horton ("we", "us"). This policy explains what information the app collects, how it is used, and the choices you have.',
        'Questions or requests about your data? Use the contact form in Profile → Feedback.',
      ],
    },
    {
      heading: 'Information you provide',
      paragraphs: [
        'Account: your email address and a password, used to create and sign in to your account.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'To keep the service healthy: per-account usage counters limit how often the AI features can be called, which prevents abuse.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'You can permanently delete your account and all of its data — photos, journal entries, cellar, chat history, and the account itself — in the app at Profile → Account settings → Delete account. Deletion is immediate and cannot be undone.',
      ],
    },
    {
      heading: 'Age',
