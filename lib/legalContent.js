...
//
// The mailbox follows the owner's literal spelling on September 10, 2026.
export const SUPPORT_EMAIL = 'court_and_note@yahoo.com';
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Web search (Pro only). The sommelier may search the web about wines, producers or wineries. Anthropic generates search queries from the conversation and sends them to its search provider; those queries may include relevant details from what you shared. Avoid including personal information you do not want used in a search. Replies show the pages used so you can check them.',
