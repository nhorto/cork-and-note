...
const buildPrivacyPolicy = (store) => ({
  ...
  sections: [
    ...
    {
      heading: 'Early access and launch notifications',
      paragraphs: [
        'If you request early access or launch news on our website, we save your email address, phone platform, selected interest, eligibility and consent confirmations, and campaign labels identifying how you found the page. We use this information to arrange testing, send the updates you requested, and understand recruitment results. It does not create an app account or enroll you in a store test.',
        'Signup requests are stored in Supabase and processed through our website host, Vercel. We also use short-lived hashed network and email identifiers to limit abuse. We do not publish the signup list. To withdraw your request or ask us to delete it, contact the support address below. We retain your request while arranging the access or notification you asked for, unless you withdraw sooner.',
      ],
    },
    {
      ...
      paragraphs: [
        ...
        'Advertising measurement on iPhone: iOS asks whether you allow Cork & Note to track activity for advertising measurement. If you allow it, Meta may receive an advertising identifier together with app-install and app-launch information so we can measure which of our ads led to downloads and improve delivery of our own ads. If you decline, we keep advertiser-identifier collection disabled. Apple and participating ad networks may still provide privacy-preserving aggregate attribution that does not identify you to us.',
      ],
    },
    {
      ...
      paragraphs: [
        ...
        'We do not sell your data or show third-party ads inside Cork & Note. We use the limited advertising measurement described above only to evaluate and improve ads for Cork & Note, and request Apple’s permission before enabling identifier-based tracking on iPhone.',
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'On Android, the Google Maps SDK collects technical request and device metadata, IP addresses, a Maps-specific identifier, and SDK crash information. An IP address can indicate your general area even when device location permission is off. The SDK may also collect map interactions such as panning and zooming. Google uses this information to operate and improve its services.',
        ...
        'When you use Plan a wine day to calculate driving times, the trip origin and selected stop coordinates are sent through our server to Google Routes. We store the trip plan and driving times so you can reopen your plan. Google may retain and use Maps Platform request data, including coordinates, to provide and improve its services under its privacy terms.',
        'Expo provides app update delivery. Update checks send technical information needed to select a compatible app update, and may provide update usage and error information used to monitor reliability. These update requests do not include your journal entries, photos, or sommelier messages.',
        'Meta provides measurement for ads promoting Cork & Note. Its SDK receives app-install and app-launch events plus technical request information used for attribution and campaign reporting. If you grant Apple’s tracking permission, the SDK may also collect the device advertising identifier and use the event to measure and optimize our Meta advertising. Cork & Note does not send Meta your name, email address, journal entries, photos, cellar, location, sommelier messages, or subscription history through this integration.',
