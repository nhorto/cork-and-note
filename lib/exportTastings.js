...
export async function shareTastingsCsv() {
  ...
  try {
    ...
    // iOS is the launch platform and takes a file url directly; `message` is the
    // Android fallback, which cannot share a local file this way.
    await Share.share({ url: uri, title: 'Cork & Note tastings' });
