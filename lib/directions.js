 ...
 */
export function directionsUrls(place, os = Platform.OS) {
  // `= {}` only covers undefined; the winery page passes null while its row
  // is still loading, and that crashed every page open (#266 regression).
