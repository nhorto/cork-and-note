...
export const aiService = {
  ...
  // Streaming is paused until the Cork & Note backend is deployed with the
  // matching function. See docs/audits/sommelier-streaming-rollout.md.
  // Both chat screens use this entry point; keep the streaming transport below
  // available for a verified backend rollout.
  async sendChatMessage(messages, systemPrompt = null, _options = {}) {
