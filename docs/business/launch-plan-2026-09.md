...
| Price | $0 | **$9.99/mo · $59.99/yr** — decided 2026-09-03, reconfirmed 2026-09-09; no lifetime SKU at launch. The **7-day free trial is on the annual product only**; monthly has none. Both live in App Store Connect since 2026-09-08, priced in all 175 territories |
...
- **Weekly "tasting trip" pass: deferred, not rejected.** The 7-day trial on annual already covers "I'm in wine country for a week," and RevenueCat can add a `pro_weekly` SKU post-launch without an app release. Revisit if RevenueCat shows a burst-usage-then-churn cohort.
