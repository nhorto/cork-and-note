...
**Status (2026-09-08, trial revised 2026-09-09):** every business decision this plan was waiting on has now been made. Pricing ($9.99/mo · $59.99/yr, **3-day** trial on **annual only** — shortened from 7 days on 2026-09-09, ASC toggle pending — no lifetime) and free meters were settled 2026-09-03; on **2026-09-08** the owner closed the four that were still open — **launch region Virginia** (§5), **v1 ships with the paywall** rather than free-first, **Anthropic capped at $100/month** (§4.3), and **no LLC: Nicholas Horton personally, Maryland law** (§7). Only **navigation Option A vs B** is left, and it still blocks the Journal tab.
...
1. ~~**Products in App Store Connect**~~ **✅ done 2026-09-08.** `pro_monthly` ($9.99/month, no trial) and `pro_annual` ($59.99/year, free trial — created as 7-day; **owner still needs to switch the intro offer to 3 days** per the 2026-09-09 decision) in the group "Cork & Note Pro", priced and available in all 175 territories. Two stray non-consumable IAPs left over from an earlier experiment were deleted at the same time, so the review submission has no unfinished products in it.
